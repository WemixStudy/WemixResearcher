...
## ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png)1. 가상자산사업자 정의
...
(예) 고객이 직접 개인키를 수기로 기록하는 방식, 별도 개인 저장공간에 저장하는 방식 등을 통해 가상자산 지갑서비스를 이용함으로써 사업자가 이에 대한 통제권이 없는 경우 제외사유에 해당하는 것으로 판단됩니다. [(유권해석: 네오플라이)](https://better.fsc.go.kr/fsc_new/replyCase/LawreqDetail.do?stNo=11&muNo=171&muGpNo=75&lawreqIdx=3828)
   ...
   ->> :no_entry_sign:***`현재 위믹스의 지갑인 플레이왈렛은 위믹스에서 통제권을 가짐`***
 ...
 * 단순히 매수 매도 제안을 게시할 수 있는 장(場)만을 제공하는 경우
  (예) 단순히 이용이 가능한 가상자산이 있다는 사실이 게재만 되어 있는 게시판을 운영할 뿐, 당사자들간 거래는 개인별 지갑이나 또는 그 게시판 관련 회사의 지갑이 아닌 별도 지갑을 통해 이뤄지는 경우
   ...
   ->> :no_entry_sign:***`현재 위믹스의 거래소인`*** https://pnix.exchange 와 www.wemixplay.com 는 ***`위믹스에서 통제권을 가지며, 위믹스가 직접 발행한 자산을 직접 상장하며, 위믹스의 지갑을 통해 이용함`***

#### ii. 예외가 아닌 경우 (금융위원회 금융정보분석원 홈페이지 유권해석 참조)
__**1. 지갑서비스업자** (관련 유권해석) 
* 고객의 :red_circle: ***`개인키(Private Key)에 대한 통제권`*** 을 가지며 가상자산의 이전·보관 등에 관여한다면 특정금융정보법상 가상자산사업자에 해당하여 같은 법에 따른 가상자산사업자로서의 신고 의무를 부담합니다.
* 고객에게 가상자산 수탁 서비스를 제공하는 자(A)가 다른 가상자산사업자(B)에게 전자지갑 발급을 위탁하여 해당 사업자(B)가 고객의 개인키를 보관·관리하는 경우에도 수탁 서비스 제공자(A)가 고객의 가상자산 :red_circle:***`개인키에 대한 실질적 통제권`*** 이 있을 수 있습니다.
...
#### _iii. 가상자산사업자 해당
1.  플레이왈렛은 :no_entry_sign: ***`위믹스에서 직접적으로 개인키를 보관 및 통제`*** 하며, 실질적으로도 통제권을 행사하며 운영함. 
...
3. :no_entry_sign: ***`위믹스에서 상장과 상장폐지를 독립적으로 결정`***함
4. 따라서 플레이체인 또는 토네이도체인이 :no_entry_sign:***`해킹, 파산, 서비스 종료시, 고객은 자신의 자산을 찾을 수 없음`***. 또한 고객의 거래/입출금 서비스에 대한 통제가 가능함
5. 해당 :no_entry_sign: ***`거래소의 수익은 위믹스의 수익으로 귀속`*** 됨

#### _iii. 가상자산사업자 해당
1. 플레이체인과 토네이도체인상 가상자산들은 :no_entry_sign: ***`위믹스에서 직접적으로 개인키를 보관 및 통제함`***
2. ***`상장, 상장폐지 및 거래소 전체 정책을 위믹스에서 독립적으로 결정 및 운영하며, 거래 및 체결 또한 위믹스에서 통제권을 가짐`***

<img width="211" alt="그림10" src="https://github.com/WemixResearcher/WemixResearcher/assets/149958468/ef48c887-d888-469d-8c56-40629c513ace">
...
3. :no_entry_sign:***`내부적으로는 MM사를 파트너로 두고, 매수매도를 적극적으로 하여 거래량을 부풀리고, 시세조종을 진행`*** 
   ##### a. MM사 파트너: 알고리스, 하이퍼리즘, 프레스토랩스(AQX) 등
   ##### b. 해당 MM사들은 법인계정이 아닌 :no_entry_sign: ***`조직적으로 직원 또는 지인 등의 별도 개인 계정`*** 을 구해서 매매 
...
## ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png)3. 위믹스 영업성
### **A. 영업 인식** 
...
### **C.국내 영향**
#### _i. 지배구조
1. 관련 모든 법인이 ***`국내 법인`*** 에 해당
#### _ii. 서비스 제공
1. :no_entry_sign:***`대부분 고객이 한국인`***
2. :no_entry_sign:***`한국어 서비스`*** 및 [고객센터](https://wemadetree.zendesk.com/hc/ko) 지원
3. 한국어 [웹사이트](http://wemix.com), [블로그](https://www.wemix.com/ko/communication), 유투브, 커뮤니티, 기타 홍보채널 운영
#### _iii. 매출 귀속
1. 해당 플랫폼의 ***`매출은 모두 국내 법인인 위메이드에 귀속`*** 됨

<br>

## ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png)4. 규제회피
### **A. 위믹스는 당국의 규제를 계획적이고 조직적으로 회피해옴**
<br>

### **B. 연혁**
#### _i. (2021.09.24.) 위메이드트리(현 위믹스), “24일에 금융위에 가상자산사업자로 신고” ([기사](https://www.businesspost.co.kr/BP?command=article_view&num=251739))
#### _ii. (2021.11.11.) 가상자산사업자 신고 사실 유지 ([증권신고서 참조](https://kind.krx.co.kr/common/disclsviewer.do?method=searchInitInfo&acptNo=20211203000601&docno=))
* “당사의 자회사인 WEMADETREE PTE. LTD.(현 위믹스 피티이 리미티드(Wemix Pte. Ltd.))는 2021년 9월 특정 금융거래정보의 보고 및 이용 등에 관련 법률에 따라 가상자산사업자 신고를 하였습니다.”
#### _iii. (2021.12.24.) 위믹스 신고 ***`자진 철회`***
“위메이드는 위메이드 월렛에 대한 신고를 철회했다. ***`신고 대상이 아닌 사유로 철회`*** 한 경우라, 영업 종료 등 철회 사업자가 이행해야 하는 후속 조치를 취할 필요가 없다.” ([기사](https://zdnet.co.kr/view/?no=20211224134104))
“위메이드트리는 가상자산 및 대체불가능토큰(NFT)을 거래, 보관할 수 있는 '위믹스월렛(현 플레이왈렛)'을 운영 중이다. 국내서 원화 없이 운영 중인 코인전용 거래소와 다르지 않은 형태다. 다만 ***`위믹스월렛(현 플레이왈렛)은 개인키를 사용자가 보관하게 해 거래소로 분류되지 않았다.`*** ” ([기사](https://www.thebell.co.kr/free/content/ArticleView.asp?key=202112270902266120106039&lcode=00))
#### _iv. (2022.11.01.) 예자선 변호사가 금융위원회에 위믹스를 특금법 위반으로 민원 ([기사](https://www.ohmynews.com/NWS_Web/View/at_pg.aspx?CNTN_CD=A0002878820))
“디오스 프로토콜과 위믹스파이 등이 특금법이 정해둔 가상자산사업자, 그중에서도 '가상자산 거래업자'의 업무 영역이라고 봤다.”
* 본문에서는 디어스 프로토콜과 위믹스파이는 다루지 않음
#### _v. (2022. 12.) 위 민원에 대해 금융위원회의 회신
“구체적인 사실관계를 파악하기 어려워 확정적으로 답변하기 어렵다” ([기사](https://www.wowtv.co.kr/NewsCenter/News/Read?articleId=A202301020200))

<br>

### **:no_entry_sign:C. 고의성**
#### _i. ***`박관호 의장과 장현국 대표는 가상자산 전문가`*** 로, 업계 초기부터 빗썸에 간접투자하고 빗썸 이사회의 이사로 활동함. 
**위메이드에서도 특금법을 인지하고 실제로 신고했으나 철회함. 현재로 가상자산 발행, 거래소, 지갑, 커스터디 등 전 분야의 가상자산 사업을 전개 중이므로 타의 추종을 불허하는 가상자산 및 관련법 전문가로 볼 수 있음.**
#### _ii. 위믹스 신고 자진 철회 당시, 위메이드측에서는 플레이왈렛은 ‘개인키를 사용자가 보관하게 해 거래소로 분류되지 않았다’고 입장을 밝혔으나, 실제로는 사용자가 플레이왈렛에서 개인키를 추출하는 것이 불가능함. :no_entry_sign:***`당국을 속인 것`***.
#### _iii. 박관호 의장과 장현국 대표는 가상자산사업자의 신고 범위에 대해 정확하게 이해하고 있었으며, 당국의 규제로 인한 사업적 비용을 절감하기 위한 의도로 신고를 철회하고 규제 회피한 것으로 보임. 그 결과, :no_entry_sign:***`특금법을 준수하지 않고도 다양한 가상자산 사업을 규제망 밖에서 자유롭게 진행`*** 하고 있음

<br>

### **D. 사례(타사 비교) 참조**
#### _i. 네오플라이 (nBlocks 지갑서비스 운영)
1. 가상자산사업자 미신고 
2. 위믹스와 동일하게, 개인키를 사용자가 보관하고 있다는 이유로 신고를 철회함. 실제로도 지갑에서 사용자가 프라이빗 추출이 가능함. ([기사](https://www.thebell.co.kr/free/content/ArticleView.asp?key=202112270902266120106039&lcode=00)) 

<img width="253" alt="그림11" src="https://github.com/WemixResearcher/WemixResearcher/assets/149958468/d95c1a3e-62b7-421d-a2f0-a8fcdc8e5be7">

3. 반면에, 위믹스는 플레이왈렛 사용자가 프라이빗키 추출이 불가능함.

<img width="330" alt="그림12" src="https://github.com/WemixResearcher/WemixResearcher/assets/149958468/280b7319-ab9e-4a50-b279-9e71ba2af1b5">

#### _ii. 페이코인 (Paycoin 발행)
1. 가상자산 사업자 신고 
2. 페이코인은 신고를 철회하지 않고, ***`재심사를 요청`*** 해 가상자산사업자로 분류됨. 금융위원회에서 심사시, 충분한 세부사항을 다알 수 없으므로, 사업자가 직접 제공하고 필요하다면 ‘재심사’를 통해 면밀검토해야함. ([기사](https://zdnet.co.kr/view/?no=20211224134104))
3. 반면에, 위믹스는 재심사를 요청하지 않음

<br>

## ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png)5. 불법영업 기간 및 규모 
### **A. 총 기간: 2021. 03. 25. ~ 2023. 11. (현재) (약 2년 8개월)**
### **B. 총 거래 규모: 수 조원 규모 (지갑 및 거래소 총 거래량 & 상장된 전체 코인 시가 총액)**
### **C. 총 고객확인 누락 대상: 2023년 2분기 기준 누적가입자수 915만명**

<br>

## ![#f03c15](https://placehold.co/15x15/f03c15/f03c15.png)6. 불법행위 처리
### **A. 불법영업행위 관련**
#### _i. FIU 유권해석 발표 ([금융위원회 공식 블로그](https://blog.naver.com/blogfsc/222851730008))

<img width="548" alt="그림13" src="https://github.com/WemixResearcher/WemixResearcher/assets/149958468/72a1fc03-cefc-4142-a681-638e05e79d91">

#### _ii. DAXA 공식입장 발표
#### _iii. 거래소 상장폐지 (미신고 가상자산사업자와 거래불가)
#### _iv. 금융정보분석원 검사 및 불법영업 행위 수사기관에 고발  

<br>

### **B. 시세조종 관련**
#### _i. 위믹스 상장 원화거래소인 코인원에서 시세조종 거래내역 확보 및 투자자와 당국에 공개
1. 특수관계인인 박관호 의장 및 관련 직원과 파트너사의 개인계정 거래내역
#### _ii. 박관호 의장의 시세조종 행위 즉각 중단 촉구 
#### _iii. 시세조종 행위 관련 형사고발
